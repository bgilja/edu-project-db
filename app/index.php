...
<html lang="en">
  ...
  <body>
    ...
    <img src="src/rimac1.jpg" class="img-fluid" alt="Responsive image">

    <div class="jumbotron">
      <h2 class="display-4">Autoservis za sve vrste vozila!</h2>
      <p class="lead">Osigurajte svom vozilu potreban servis. Omogućili smo vam povoljne i kvalitetne usluge održavanja vašeg vozila.</p>
      <hr class="my-4">
      <p>Uz registraciju na našoj web stranici imate mogućnost pratiti povijest popravaka vaših vozila.</p>
    </div>
